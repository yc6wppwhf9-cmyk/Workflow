...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-10 w-[min(320px,calc(100vw-1rem))] bg-white rounded-xl border border-gray-200 shadow-xl z-50">
          {/* Header */}
          ...
          {pushEnabled === false && (
            <div className="flex items-center justify-between px-4 py-2.5 bg-amber-50 border-b border-amber-100">
              ...
              <button
                onClick={enablePush}
                className="text-xs font-semibold text-amber-800 hover:underline shrink-0 ml-2"
              >
                Enable
              </button>
            </div>
